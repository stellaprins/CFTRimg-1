...
exp(3).conditionStr	= {'WT 37°C','F508del 37°C', 'F508del + VX-809 37°C'};
...
exp(4).conditionStr	= {'WT 37°C','F508del 37°C', 'F508del + VX-809 37°C'};
...
exp(5).conditionStr	= {'WT 28°C','F508del 28°C', 'F508del + VX-809 28°C'};

exp(5).condWells(1,1:4) = {'C02','C04','D06','C08'};
exp(5).condWells(2,1:4) = {'D02','D04','D06','D08'};
exp(5).condWells(3,1:4) = {'E02','E04','D06','E08'};
...
exp(6).conditionStr	= {'WT 37°C','F508del 37°C', 'F508del + VX-809 37°C'};
...
exp(7).conditionStr	= {'WT 28°C','F508del 28°C', 'F508del + VX-809 28°C'};

exp(7).condWells(1,1:4) = {'C02','C04','D06','C08'};
exp(7).condWells(2,1:4) = {'D02','D04','D06','D08'};
exp(7).condWells(3,1:4) = {'E02','E04','D06','E08'};
