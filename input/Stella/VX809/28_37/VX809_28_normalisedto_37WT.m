...
exp(2).expStr						= 'Stella localisation 60x temp corrected VX809 expensive plate_Plate_15659';
exp(2).baseFolder				= 'C:\Users\StellaPrins\Documents\DATA\Stella\VX809\02-11-17';
exp(2).local_quench			= 'local';
exp(2).filePrefix				= 'Stella localisation 60x temp corrected VX809 expensive plate_';
