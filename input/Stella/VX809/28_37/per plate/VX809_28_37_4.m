...
exp(1).expStr       = 'Stella local VX809 temp correct 03-11-17 expensive plate_Plate_15672';
exp(1).baseFolder		= 'C:\Users\StellaPrins\Documents\DATA\Stella\VX809\03-11-17';
exp(1).local_quench = 'local';
exp(1).filePrefix   = 'Stella local VX809 temp correct 03-11-17 expensive plate_';
...
exp(2).expStr						= 'Stella local VX809 37degrees 03-11-17 expensive plate_Plate_15676';
exp(2).baseFolder				= 'C:\Users\StellaPrins\Documents\DATA\Stella\VX809\03-11-17';
exp(2).local_quench			= 'local';
exp(2).filePrefix				= 'Stella local VX809 37degrees 03-11-17 expensive plate_';
