...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
exp(2).plateStr					= {'37°C 1'};
exp(2).expStr						= 'Stella local VX809 37degrees expensive plate 02-11-17_Plate_15663';
exp(2).baseFolder				= 'C:\Users\StellaPrins\Documents\DATA\Stella\VX809\02-11-17';
exp(2).local_quench			= 'local';
exp(2).filePrefix				= 'Stella local VX809 37degrees expensive plate 02-11-17_';
