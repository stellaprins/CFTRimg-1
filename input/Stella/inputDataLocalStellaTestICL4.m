...
exp(1).condWells(1,1) = {'B02'};%, 'C02','D02','E02','F02','G02'};
exp(1).condWells(2,1) = {'B03'};%,'C03','D03','E03','F03','G03'};
exp(1).condWells(3,1) = {'B04'};%,'C04','D04','E04','F04'};
exp(1).condWells(4,1) = {'B05'};%,'C05','D05','E05','F05','G05'};
exp(1).condWells(5,1) = {'B06'};%,'C06','D06','E06','F06','G06'};
exp(1).condWells(6,1) = {'B07'};%,'C07','D07','E07','F07','G07'};
exp(1).condWells(7,1) = {'B08'};%,'C08','D08','E08','F08','G08'};
exp(1).condWells(8,1) = {'B09'};%,'C09','D09','E09','F09','G09'};
exp(1).condWells(9,1) = {'B10'};%,'C10','D10','E10','F10','G10'};
exp(1).condWells(10,1) = {'B11'};%,'C11','D11','E11','F11','G11'};
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% exp(2).condWells(1,1) = {'C02'};%,'D02'};%,'E02','F02','G02'};
% exp(2).condWells(2,1:2) = {'B03'};%,'C03'};%,'D03','E03','F03'%,'G03'};
% exp(2).condWells(3,1) = {'B04'};%,'C04','D04','F04','G04'};
% exp(2).condWells(4,1)   = {'B05'};%,'C05','D05','E05','F05','G05'};
% exp(2).condWells(5,1)   = {'B06'};%,'C06','D06','E06','F06','G06'};
% exp(2).condWells(6,1)   = {'B07'};%,'C07','D07','E07','F07','G07'};
% exp(2).condWells(7,1)   = {'B08'};%,'C08','D08','E08','F08','G08'};
% exp(2).condWells(8,1)   = {'B09'};%,'C09','D09','E09','F09','G09'};
% exp(2).condWells(9,1) = {'B10'};%,'C10','E10','F10','G10'};
% exp(2).condWells(10,1)  = {'B12'};%,'C12','D12','E12','F12','G12'};
% %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
